...
source(".\\Session02\\varImpBiomod.R") 
...
study_area <- readOGR(".\\data", "continents")
plot(study_area)
...
if (file.exists("./GIS/Synceruscaffer/Synceruscaffer.mif")) {
  ...
  #writeOGR(species, ".\\data", 
    #       "Synceruscaffer", driver="MapInfo File", dataset_options="FORMAT=MIF")
}
